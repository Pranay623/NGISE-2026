            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <div className="space-y-6 text-gray-700">
                        ...
                        <p className="text-lg font-bold text-gray-900 mt-8 mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-3">
                    {topics.map((topic, index) => (
                        ...
                        >
                            <span className="mt-2 w-1.5 h-1.5 rounded-full bg-blue-500 group-hover:scale-150 transition-transform flex-shrink-0" />
                            <span className="text-gray-700 text-lg leading-snug group-hover:text-blue-700 transition-colors">
                                {topic.title}
                            </span>
                        </motion.div>
                    ))}
