  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <PageHeader
        ...
        description="Mark your calendars for these key deadlines and event dates"
      />
          ...
          <motion.div className="max-w-3xl mx-auto" initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <div className="space-y-6">
              {importantDates.map((item, i) => (
                <motion.div
                  key={i}
                  className={`flex items-center p-6 rounded-xl border-2 ${item.status === "highlighted" ? "bg-blue-50 border-blue-200" : "bg-white border-gray-200"
