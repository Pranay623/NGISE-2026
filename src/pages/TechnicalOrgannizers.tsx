...
export default function TechnicalOrgannizers() {
    const members = [
        ...
        "Darusalam Darusalam, Bina Nusantara University, Jakarta, Indonesia",
        ...
        "Sven Groppe, TU Bergakademie Freiberg, Germany",
        ...
        "Kevin Patel, Illinois Institute of Technology, Chicago, USA",
        ...
        "Rudolf Ramler, SCCH (Software Competence Center Hagenberg), Austria",
        ...
        "Weixing Zhang, Karlsruhe Institute of Technology, Germany",
